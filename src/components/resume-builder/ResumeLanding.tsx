      ...
      <div className="max-w-4xl w-full flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          ...
          <button
            ...
            className="group relative flex flex-col items-center text-center gap-6 p-8 rounded-2xl border bg-card shadow-sm hover:shadow-xl transition-[box-shadow,transform] duration-300 hover:-translate-y-1 cursor-pointer overflow-hidden"
          >
              ...
              {TEMPLATES.map((tpl) => (
                <div key={tpl} className="flex flex-col gap-4">
                  <div
                    role="button"
                    tabIndex={0}
                    className="group relative w-full rounded-xl border-2 border-transparent hover:border-primary cursor-pointer transition-[border-color,box-shadow] duration-300 shadow-md hover:shadow-xl overflow-hidden bg-white"
